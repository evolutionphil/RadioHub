    ...
    <div className="bg-[#0E0E0E]">
      ...
      <div className="bg-[#0E0E0E] border-b border-[#1D1D1D]">
        <div className="container mx-auto px-4 py-8">
          <h1 className="text-3xl lg:text-4xl font-bold text-white">{t('page_terms_conditions') || 'Terms and Conditions'}</h1>
          <p className="text-gray-400 mt-2">{t('page_terms_subtitle') || 'Terms of use for Mega Radio services'}</p>
        </div>
      </div>
