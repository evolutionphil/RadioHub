...
interface AppStoreDownloadLinkProps {
  className?: string;
  link?: string;
...
export function AppStoreDownloadLink({ className = "", link, unavailableLabel, downloadLabel = 'Download on the' }: AppStoreDownloadLinkProps) {
  return (
