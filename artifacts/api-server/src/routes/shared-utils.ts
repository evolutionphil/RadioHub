...
export const TV_STATION_FIELDS = {
  ...
  codec: 1, bitrate: 1, hls: 1, logoAssets: 1, lastCheckOk: 1, isListVisible: 1, availabilityStatus: 1
};
...
export function tvSlimStation(s: any) {
  return {
    ...
    isListVisible: s.isListVisible !== false, availabilityStatus: s.availabilityStatus || 'unverified'
  };
}
