...
CRITICAL RATE LIMIT RULE: Bot rate limits are 300/min for major search bots (Google, Bing) and 60/min for minor bots. Previous value of 15/min was too restrictive and caused Google crawling failures.
