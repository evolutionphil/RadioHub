...
- **External API Resilience**: iTunes API circuit breaker (5-min cooldown, silent null return on failure, 10-min log throttling), recommendation engine guard against concurrent computations.
