...
export const SEARCH_SEO_TEMPLATES: Record<string, SearchSeoTemplate> = {
  en: {
    ...
    description: 'Search 60,000+ live radio stations from 120+ countries on Mega Radio. Find your favourite station by name, genre, language, or country and listen free online.',
  ...
  es: {
    ...
    description: 'Busca entre más de 60.000 emisoras en vivo de más de 120 países en Mega Radio. Encuentra tu emisora favorita por nombre, género, idioma o país y escucha gratis.',
  ...
  fr: {
    ...
    description: 'Recherchez parmi 60 000+ stations radio en direct de 120+ pays sur Mega Radio. Trouvez votre station par nom, genre, langue ou pays et écoutez gratuitement.',
  ...
  de: {
    ...
    description: 'Durchsuche 60.000+ Live-Radiosender aus 120+ Ländern auf Mega Radio. Finde deinen Lieblingssender nach Name, Genre, Sprache oder Land und höre kostenlos.',
  ...
  ar: {
    ...
    description: 'ابحث في أكثر من 60,000 محطة راديو مباشرة من أكثر من 120 دولة على Mega Radio. اعثر على محطتك المفضلة بالاسم أو النوع أو اللغة أو البلد واستمع مجانًا.',
  ...
  it: {
    ...
    description: 'Cerca tra oltre 60.000 stazioni radio in diretta da oltre 120 paesi su Mega Radio. Trova la tua stazione per nome, genere, lingua o paese e ascolta gratis.',
  ...
  pt: {
    ...
    description: 'Procure entre mais de 60.000 rádios ao vivo de mais de 120 países na Mega Radio. Encontre a sua rádio por nome, género, idioma ou país e ouça grátis.',
  ...
  nl: {
    ...
    description: 'Doorzoek 60.000+ live radiostations uit 120+ landen op Mega Radio. Vind je favoriete station op naam, genre, taal of land en luister gratis online.',
  ...
  pl: {
    ...
    description: 'Przeszukaj 60 000+ stacji radiowych na żywo ze 120+ krajów w Mega Radio. Znajdź swoją stację po nazwie, gatunku, języku lub kraju i słuchaj za darmo.',
  ...
  sv: {
    ...
    description: 'Sök bland 60 000+ liveradiostationer från 120+ länder på Mega Radio. Hitta din favoritstation via namn, genre, språk eller land och lyssna gratis.',
  ...
  el: {
    ...
    description: 'Αναζητήστε ανάμεσα σε 60.000+ ζωντανούς ραδιοφωνικούς σταθμούς από 120+ χώρες στο Mega Radio. Βρείτε τον σταθμό σας ανά όνομα, είδος, γλώσσα ή χώρα.',
  ...
  hu: {
    ...
    description: 'Keress 60 000+ élő rádióállomás között 120+ országból a Mega Radio-n. Találd meg az állomást név, műfaj, nyelv vagy ország alapján és hallgass ingyen.',
  ...
  cs: {
    ...
    description: 'Prohledejte 60 000+ živých rozhlasových stanic ze 120+ zemí na Mega Radio. Najděte stanici podle názvu, žánru, jazyka nebo země a poslouchejte zdarma.',
  ...
  sk: {
    ...
    description: 'Prehľadajte 60 000+ živých rozhlasových staníc zo 120+ krajín na Mega Radio. Nájdite svoju stanicu podľa názvu, žánru, jazyka alebo krajiny a počúvajte zadarmo.',
  ...
  bg: {
    ...
    description: 'Търсете сред 60 000+ радиостанции на живо от 120+ страни в Mega Radio. Намерете своята станция по име, жанр, език или страна и слушайте безплатно.',
  ...
  sl: {
    ...
    description: 'Preiščite 60.000+ radijskih postaj v živo iz 120+ držav na Mega Radio. Najdite postajo po imenu, žanru, jeziku ali državi in poslušajte brezplačno.',
  ...
  lv: {
    ...
    description: 'Meklē starp 60 000+ tiešraides radio stacijām no 120+ valstīm Mega Radio. Atrodi staciju pēc nosaukuma, žanra, valodas vai valsts un klausies bezmaksas.',
  ...
  lt: {
    ...
    description: 'Ieškokite tarp 60 000+ tiesioginių radijo stočių iš 120+ šalių Mega Radio. Raskite stotį pagal pavadinimą, žanrą, kalbą ar šalį ir klausykite nemokamai.',
  ...
  vi: {
    ...
    description: 'Tìm trong hơn 60.000 đài phát thanh trực tiếp từ hơn 120 quốc gia trên Mega Radio. Tìm đài yêu thích theo tên, thể loại, ngôn ngữ hoặc quốc gia và nghe miễn phí.',
  ...
  id: {
    ...
    description: 'Cari di antara 60.000+ stasiun radio langsung dari 120+ negara di Mega Radio. Temukan stasiun favorit Anda berdasarkan nama, genre, bahasa, atau negara dan dengarkan gratis.',
  ...
  ms: {
    ...
    description: 'Cari antara 60,000+ stesen radio langsung dari 120+ negara di Mega Radio. Cari stesen kegemaran anda mengikut nama, genre, bahasa atau negara dan dengar percuma.',
  ...
  tl: {
    ...
    description: 'Maghanap mula sa 60,000+ live na istasyon ng radyo mula sa 120+ bansa sa Mega Radio. Hanapin ang istasyon ayon sa pangalan, genre, wika, o bansa at makinig nang libre.',
  ...
  fa: {
    ...
    description: 'بین بیش از 60,000 ایستگاه رادیویی زنده از بیش از 120 کشور در Mega Radio جستجو کنید. ایستگاه مورد علاقه خود را بر اساس نام، ژانر، زبان یا کشور پیدا کنید و رایگان گوش دهید.',
  ...
  ur: {
    ...
    description: 'Mega Radio پر 120+ ممالک کے 60,000+ براہ راست ریڈیو اسٹیشنز تلاش کریں۔ اپنا پسندیدہ اسٹیشن نام، صنف، زبان یا ملک کے لحاظ سے تلاش کریں اور مفت سنیں۔',
  ...
  ta: {
    ...
    description: 'Mega Radio இல் 120+ நாடுகளில் இருந்து 60,000+ நேரலை வானொலி நிலையங்களில் தேடுங்கள். பெயர், வகை, மொழி அல்லது நாட்டின் அடிப்படையில் உங்கள் நிலையத்தைக் கண்டறிந்து இலவசமாகக் கேளுங்கள்.',
  ...
  ml: {
    ...
    description: 'Mega Radio-യിൽ 120+ രാജ്യങ്ങളിൽ നിന്നുള്ള 60,000+ ലൈവ് റേഡിയോ സ്റ്റേഷനുകൾ തിരയുക. പേര്, ജോണർ, ഭാഷ അല്ലെങ്കിൽ രാജ്യം പ്രകാരം നിങ്ങളുടെ സ്റ്റേഷൻ കണ്ടെത്തി സൗജന്യമായി കേൾക്കുക.',
  ...
  sw: {
    ...
    description: 'Tafuta kati ya vituo 60,000+ vya redio vya moja kwa moja kutoka nchi 120+ kwenye Mega Radio. Pata kituo chako kwa jina, aina, lugha au nchi na sikiliza bure.',
  ...
  zu: {
    ...
    description: 'Sesha phakathi kweziteshi zomsakazo ezingu-60,000+ ezibukhoma kusukela emazweni angu-120+ ku-Mega Radio. Thola isiteshi sakho ngegama, uhlobo, ulimi noma izwe ulalele mahhala.',
  ...
  sq: {
    ...
    description: 'Kërko mes 60.000+ stacioneve radio live nga 120+ vende në Mega Radio. Gjej stacionin tënd sipas emrit, zhanrit, gjuhës ose vendit dhe dëgjo falas.',
  ...
  so: {
    ...
    description: 'Ka raadi 60,000+ xarumood raadiyo oo tooska ah oo ka socda 120+ waddan Mega Radio. Hel xaruntaada magaca, nooca, luqadda ama dalka, dhageyso bilaash.',
  ...
  uk: {
    ...
    description: 'Шукайте серед 60 000+ радіостанцій у прямому ефірі зі 120+ країн на Mega Radio. Знайдіть станцію за назвою, жанром, мовою чи країною й слухайте безкоштовно.',
